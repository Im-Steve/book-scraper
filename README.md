...
### Notes
- When acquiring book links, any catalogs where an error occurred are logged in a file named "errorsWithGet.xlsx". These catalogs can be revisited using the "get-errors" command.
